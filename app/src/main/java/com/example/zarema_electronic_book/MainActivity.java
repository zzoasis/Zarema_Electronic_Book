package com.example.zarema_electronic_book;
...
public class MainActivity extends AppCompatActivity
    ...
    private void openLinkExternally() {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.soccer.ru/teams/teamschedule/65.shtml"));
        try {
    ...
    private void sendMail() {
        ...
        i.putExtra(Intent.EXTRA_EMAIL, new String[]{"email@example.com"});
        i.putExtra(Intent.EXTRA_SUBJECT, "Предложения по приложению");
